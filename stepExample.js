(function (n, t) {
    ...
    function be(n, t) {
        ...
        if (1 === t.nodeType) {
            ...
            "script" === r && t.text !== n.text ? (nu(t)
                .text = n.text, tu(t)) : "object" === r ? (t.parentNode && (t.outerHTML = n.outerHTML), i.support.html5Clone && n.innerHTML && !i.trim(t.innerHTML) && (t.innerHTML = n.innerHTML)) : "input" === r && oi.test(n.type) ? (t.defaultChecked = t.checked = n.checked, t.value !== n.value && (t.value = n.value)) : "option" === r ? t.defaultSelected = t.selected = n.defaultSelected : ("input" === r || "textarea" === r) && (t.defaultValue = n.defaultValue)
        }
    }
    ...
    function ou(n, t) {
        ...
        for (var r = t.charAt(0)
            .toUpperCase() + t.slice(1), u = t, i = eu.length; i--;)
    ...
    function au(n) {
        var u = r,
            t = uu[n];
        return t || (t = vu(n, u), "none" !== t && t || (rt = (rt || i("<iframe frameborder='0' width='0' height='0'/>")
            .css("cssText", "display:block !important"))
            .appendTo(u.documentElement), u = (rt[0].contentWindow || rt[0].contentDocument)
            .document, u.write("<!doctype html><html><body>"), u.close(), t = vu(n, u), rt.detach()), uu[n] = t), t
    }
        ...
        return function (t, r) {
            ...
            var u, f = 0,
                e = t.toLowerCase()
                    .match(s) || [];
            if (i.isFunction(r))
                while (u = e[f++]) "+" === u[0] ? (u = u.slice(1) || "*", (n[u] = n[u] || [])
                    .unshift(r)) : (n[u] = n[u] || [])
                    .push(r)
        }
    }
    ...
    function ef(n, t, i) {
        for (var u, f = (ft[t] || [])
            .concat(ft["*"]), r = 0, e = f.length; e > r; r++)
    ...
    i.fn = i.prototype = {
        ...
        init: function (n, u, f) {
            ...
            if (!n) return this;
            if ("string" == typeof n) {
                if (e = "<" === n.charAt(0) && ">" === n.charAt(n.length - 1) && n.length >= 3 ? [null, n, null] : yf.exec(n), !e || !e[1] && u) return !u || u.jquery ? (u || f)
    ...
    i.extend({
        ...
        ready: function (n) {
            if (n === !0 ? !--i.readyWait : !i.isReady) {
                ...
                i.isReady = !0;
                n !== !0 && --i.readyWait > 0 || (et.resolveWith(r, [i]), i.fn.trigger && i(r)
                    .trigger("ready")
                    .off("ready"))
            }
        },
        ...
        parseHTML: function (n, t, u) {
            ...
            var f = nr.exec(n),
                e = !u && [];
            return f ? [t.createElement(f[1])] : (f = i.buildFragment([n], t, e), e && i(e)
                .remove(), i.merge([], f.childNodes))
        },
        parseJSON: function (r) {
            return n.JSON && n.JSON.parse ? n.JSON.parse(r) : null === r ? r : "string" == typeof r && (r = i.trim(r), r && pf.test(r.replace(bf, "@")
                .replace(kf, "]")
                .replace(wf, ""))) ? Function("return " + r)() : (i.error("Invalid JSON: " + r), t)
        },
        parseXML: function (r) {
            var u, f;
    ...
    bi = i(r),
        function (n, t) {
                ...
                for (var s, u, i, e = n.length, h = r.relative[n[0].type], c = h || r.relative[" "], t = h ? 1 : 0, l = fi(function (n) {
                    ...
                    if (u = r.relative[n[t].type]) f = [fi(ei(f), u)];
                        ...
                        if (u = r.filter[n[t].type].apply(null, n[t].matches), u[o]) {
                            ...
                            return oi(t > 1 && ei(f), t > 1 && wt(n.slice(0, t - 1)
                                .concat({
                                    value: " " === n[t - 2].type ? "*" : ""
                                }))
            ...
            function pr(n, t, i, u) {
                ...
                if (!u && 1 === h.length) {
                    if (f = h[0] = h[0].slice(0), f.length > 2 && "ID" === (o = f[0])
                        .type && e.getById && 9 === t.nodeType && v && r.relative[f[1].type]) {
            ...
            nt = u.setDocument = function (n) {
                ...
                return i !== s && 9 === i.nodeType && i.documentElement ? (s = i, a = i.documentElement, v = !hi(i), u && u.attachEvent && u !== u.top && u.attachEvent("onbeforeunload", function () {
                    ...
                    return n.appendChild(i.createComment("")), !n.getElementsByTagName("*")
                        .length
                }), e.getElementsByClassName = l(function (n) {
                    return n.innerHTML = "<div class='a'><\/div><div class='a i'><\/div>", n.firstChild.className = "i", 2 === n.getElementsByClassName("i")
                        .length
            ...
            r = u.selectors = {
                ...
                filter: {
                    ...
                    ATTR: function (n, t, i) {
                        return function (r) {
                            var f = u.attr(r, n);
                            return null == f ? "!=" === t : t ? (f += "", "=" === t ? f === i : "!=" === t ? f !== i : "^=" === t ? i && 0 === f.indexOf(i) : "*=" === t ? i && f.indexOf(i) > -1 : "$=" === t ? i && f.slice(-i.length) === i : "~=" === t ? (" " + f + " ")
                                .indexOf(i) > -1 : "|=" === t ? f === i || f.slice(0, i.length + 1) === i + "-" : !1) : !0
                        }
                    },
                ...
                pseudos: {
                    ...
                    contains: c(function (n) {
                        return function (t) {
                            return (t.textContent || t.innerText || ct(t))
                                .indexOf(n) > -1
                        }
                    }),
                    lang: c(function (n) {
                        return er.test(n || "") || u.error("unsupported lang: " + n), n = n.replace(k, d)
                            .toLowerCase(),
                            function (t) {
                                var i;
                                do
    ...
    i.extend({
                        ...
                        return i.Deferred(function (f) {
                            i.each(u, function (u, e) {
                                ...
                                t[e[1]](function () {
                                    ...
                                    n && i.isFunction(n.promise) ? n.promise()
                                        .done(f.resolve)
                                        .fail(f.reject)
                                        .progress(f.notify) : f[s + "With"](this === r ? f.promise() : this, o ? [n] : arguments)
                                })
                            });
                            n = null
                        })
        ...
        when: function (n) {
            var t = 0,
                ...
                o, c, s;
            if (r > 1)
                for (o = Array(r), c = Array(r), s = Array(r); r > t; t++) u[t] && i.isFunction(u[t].promise) ? u[t].promise()
                    .done(h(t, s, u))
                    .fail(f.reject)
                    .progress(h(t, c, o)) : --e;
    ...
    i.support = function (t) {
        ...
        t.tbody = !u.getElementsByTagName("tbody")
            .length;
        t.htmlSerialize = !!u.getElementsByTagName("link")
            .length;
        ...
        t.enctype = !!r.createElement("form")
            .enctype;
        t.html5Clone = "<:nav><\/:nav>" !== r.createElement("nav")
            .cloneNode(!0)
            .outerHTML;
        ...
        f.checked = !0;
        t.noCloneChecked = f.cloneNode(!0)
            .checked;
        h.disabled = !0;
        ...
        return t.ownLast = "0" !== s, i(function () {
            ...
            s && (h = r.createElement("div"), h.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", s.appendChild(h)
                .appendChild(u), u.innerHTML = "<table><tr><td><\/td><td>t<\/td><\/tr><\/table>", f = u.getElementsByTagName("td"), f[0].style.cssText = "padding:0;margin:0;border:0;display:none", y = 0 === f[0].offsetHeight, f[0].style.display = "", f[1].style.display = "none", t.reliableHiddenOffsets = y && 0 === f[0].offsetHeight, u.innerHTML = "", u.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", i.swap(s, null != s.style.zoom ? {
                zoom: 1
            } : {}, function () {
                t.boxSizing = 4 === u.offsetWidth
            }), n.getComputedStyle && (t.pixelPosition = "1%" !== (n.getComputedStyle(u, null) || {})
                .top, t.boxSizingReliable = "4px" === (n.getComputedStyle(u, null) || {
                width: "4px"
            })
                .width, e = u.appendChild(r.createElement("div")), e.style.cssText = u.style.cssText = c, e.style.marginRight = e.style.width = "0", u.style.width = "1px", t.reliableMarginRight = !parseFloat((n.getComputedStyle(e, null) || {})
                .marginRight)), typeof u.style.zoom !== o && (u.innerHTML = "", u.style.cssText = c + "width:1px;padding:1px;display:inline;zoom:1", t.inlineBlockNeedsLayout = 3 === u.offsetWidth, u.style.display = "block", u.innerHTML = "<div><\/div>", u.firstChild.style.width = "5px", t.shrinkWrapBlocks = 3 !== u.offsetWidth, t.inlineBlockNeedsLayout && (s.style.zoom = 1)), s.removeChild(h), h = u = f = e = null)
        }), a = h = c = l = e = f = null, t
    }({});
    ir = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/;
    rr = /([A-Z])/g;
    ...
    i.fn.extend({
        ...
        addClass: function (n) {
            ...
            if (c)
                for (e = (n || "")
                    .match(s) || []; h > f; f++)
                    if (t = this[f], r = 1 === t.nodeType && (t.className ? (" " + t.className + " ")
                        .replace(ii, " ") : " ")) {
        ...
        val: function (n) {
            ...
            return arguments.length ? (e = i.isFunction(n), this.each(function (u) {
                var f;
                1 === this.nodeType && (f = e ? n.call(this, u, i(this)
                    .val()) : n, null == f ? f = "" : "number" == typeof f ? f += "" : i.isArray(f) && (f = i.map(f, function (n) {
                    return null == n ? "" : n + ""
    ...
    i.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function (n, t) {
                    for (var u, r, f = n.options, e = i.makeArray(t), o = f.length; o--;) r = f[o], (r.selected = i.inArray(i(r)
                        .val(), e) >= 0) && (u = !0);
    ...
    i.each(["radio", "checkbox"], function () {
        i.valHooks[this] = {
            set: function (n, r) {
                return i.isArray(r) ? n.checked = i.inArray(i(n)
                    .val(), r) >= 0 : t
            }
        };
    ...
    i.event = {
        ...
        add: function (n, r, u, f, e) {
            ...
            if (y) {
                for (u.handler && (w = u, u = w.handler, e = w.selector), u.guid || (u.guid = i.guid++), (p = y.events) || (p = y.events = {}), (l = y.handle) || (l = y.handle = function (n) {
                    ...
                    .match(s) || [""], k = r.length; k--;) b = hr.exec(r[k]) || [], h = g = b[1], d = (b[2] || "")
                    .split(".")
                    .sort(), h && (c = i.event.special[h] || {}, h = (e ? c.delegateType : c.bindType) || h, c = i.event.special[h] || {}, a = i.extend({
                    type: h,
                    origType: g,
                    data: f,
                    handler: u,
        ...
        remove: function (n, t, r, u, f) {
            ...
            if (v && (a = v.events)) {
                for (t = (t || "")
                    .match(s) || [""], p = t.length; p--;)
                    if (h = hr.exec(t[p]) || [], e = k = h[1], w = (h[2] || "")
                        .split(".")
                        .sort(), e) {
            ...
            if (c[0] = n, n.delegateTarget = this, !f.preDispatch || f.preDispatch.call(this, n) !== !1) {
                for (h = i.event.handlers.call(this, n, a), o = 0;
                    ...
                    for (n.currentTarget = u.elem, s = 0;
                         (r = u.handlers[s++]) && !n.isImmediatePropagationStopped();)(!n.namespace_re || n.namespace_re.test(r.namespace)) && (n.handleObj = r, n.data = r.data, e = ((i.event.special[r.origType] || {})
                        .handle || r.handler)
                        .apply(u.elem, c), e !== t && (n.result = e) === !1 && (n.preventDefault(), n.stopPropagation()));
            ...
            if (h && u.nodeType && (!n.button || "click" !== n.type))
                for (; u != this; u = u.parentNode || this)
                    if (1 === u.nodeType && (u.disabled !== !0 || "click" !== n.type)) {
                        for (f = [], s = 0; h > s; s++) o = r[s], e = o.selector + " ", f[e] === t && (f[e] = o.needsContext ? i(e, this)
                            .index(u) >= 0 : i.find(e, this, null, [u])
                            .length), f[e] && f.push(o);
                        f.length && c.push({
                            elem: u,
                            handlers: f
    ...
    i.fn.extend({
        ...
        index: function (n) {
            return n ? "string" == typeof n ? i.inArray(this[0], i(n)) : i.inArray(n.jquery ? n[0] : n, this) : this[0] && this[0].parentNode ? this.first()
                .prevAll()
                .length : -1
        },
        add: function (n, t) {
    ...
    i.extend({
        ...
        dir: function (n, r, u) {
            for (var e = [], f = n[r]; f && 9 !== f.nodeType && (u === t || 1 !== f.nodeType || !i(f)
                .is(u));) 1 === f.nodeType && e.push(f), f = f[r];
            return e
        },
    ...
    i.fn.extend({
        ...
        replaceWith: function () {
            ...
            return this.domManip(arguments, function (r) {
                var u = t[n++],
                    f = t[n++];
                f && (u && u.parentNode !== f && (u = this.nextSibling), i(this)
        ...
        domManip: function (n, t, r) {
            ...
            if (l && (s = i.buildFragment(n, this[0].ownerDocument, !1, !r && this), h = s.firstChild, 1 === s.childNodes.length && (s = h), h)) {
                ...
                if (c)
                    for (v = o[o.length - 1].ownerDocument, i.map(o, tu), e = 0; c > e; e++) f = o[e], dr.test(f.type || "") && !i._data(f, "globalEval") && i.contains(v, f) && (f.src ? i._evalUrl(f.src) : i.globalEval((f.text || f.textContent || f.innerHTML || "")
                        .replace(pe, "")));
                s = h = null
            }
            return this
    ...
    i(function () {
        ...
        !i.support.pixelPosition && i.fn.position && i.each(["top", "left"], function (n, r) {
            i.cssHooks[r] = {
                get: function (n, u) {
                    return u ? (u = y(n, r), lt.test(u) ? i(n)
                        .position()[r] + "px" : u) : t
                }
            }
        })
            ...
            return this.map(function () {
                ...
                .filter(function () {
                    ...
                    return this.name && !i(this)
                        .is(":disabled") && oo.test(this.nodeName) && !eo.test(n) && (this.checked || !oi.test(n))
                })
                .map(function (n, t) {
                    var r = i(this)
                        .val();
    ...
    i.extend({
        ...
        ajax: function (n, r) {
            ...
            if (tt.promise(f)
                .complete = it.add, f.success = f.done, f.error = f.fail, u.url = ((n || u.url || c) + "")
                .replace(so, "")
                .replace(lo, w[1] + "//"), u.type = r.method || r.type || u.method || u.type, u.dataTypes = i.trim(u.dataType || "*")
                .toLowerCase()
                .match(s) || [""], null == u.crossDomain && (l = wu.exec(u.url.toLowerCase()), u.crossDomain = !(!l || l[1] === w[1] && l[2] === w[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (w[3] || ("http:" === w[1] ? "80" : "443")))), u.data && u.processData && "string" != typeof u.data && (u.data = i.param(u.data, u.traditional)), nf(ku, u, r, f), 2 === o) return f;
            v = u.global;
    ...
    i.ajaxPrefilter("json jsonp", function (r, u, f) {
        var e, s, o, h = r.jsonp !== !1 && (at.test(r.url) ? "url" : "string" == typeof r.data && !(r.contentType || "")
            .indexOf("application/x-www-form-urlencoded") && at.test(r.data) && "data");
        ...
        if (!r.crossDomain || i.support.cors) {
            ...
            return {
                send: function (f, e) {
                    ...
                    r.async ? 4 === o.readyState ? setTimeout(u) : (h = ++tf, vt && (nt || (nt = {}, i(n)
                        .unload(vt)), nt[h] = u), o.onreadystatechange = u) : u()
                },
                abort: function () {
                    u && u(t, !0)
                }
    ...
    i.each({
        ...
        i.fn[n] = function (f) {
            return i.access(this, function (n, f, e) {
                var o = sf(n);
                return e === t ? o ? r in o ? o[r] : o.document.documentElement[f] : n[f] : (o ? o.scrollTo(u ? i(o)
...
! function (n) {
    var t = function (t, i) {
            this.options = i;
            this.$element = n(t)
                .delegate('[data-dismiss="modal"]', "click.dismiss.modal", n.proxy(this.hide, this));
    ...
    t.prototype = {
        ...
        show: function () {
            ...
            (this.$element.trigger(i), this.isShown || i.isDefaultPrevented()) || (this.isShown = !0, this.escape(), this.backdrop(function () {
                ...
                t.$element.parent()
                    .length || t.$element.appendTo(document.body);
                t.$element.show();
        ...
        hide: function (t) {
            t && t.preventDefault();
            var i = this;
            (t = n.Event("hide"), this.$element.trigger(t), this.isShown && !t.isDefaultPrevented()) && (this.isShown = !1, this.escape(), n(document)
                .off("focusin.modal"), this.$element.removeClass("in")
                .attr("aria-hidden", !0), n.support.transition && this.$element.hasClass("fade") ? this.hideWithTransition() : this.hideModal())
        },
        enforceFocus: function () {
            var t = this;
            n(document)
                .on("focusin.modal", function (n) {
                    t.$element[0] === n.target || t.$element.has(n.target)
        ...
        backdrop: function (t) {
            ...
            if (this.isShown && this.options.backdrop) {
                if (i = n.support.transition && r, this.$backdrop = n('<div class="modal-backdrop ' + r + '" />')
                    .appendTo(document.body), this.$backdrop.click(this.options.backdrop == "static" ? n.proxy(this.$element[0].focus, this.$element[0]) : n.proxy(this.hide, this)), i && this.$backdrop[0].offsetWidth, this.$backdrop.addClass("in"), !t) return;
...
! function (n) {
    ...
    t.prototype = {
        ...
        toggle: function () {
            var t = n(this),
                i, f;
            if (!t.is(".disabled, :disabled")) return i = u(t), f = i.hasClass("open"), r(), f || ("ontouchstart" in document.documentElement && n('<div class="dropdown-backdrop"/>')
                .insertBefore(n(this))
                .on("click", r), i.toggleClass("open")), t.focus(), !1
        },
        keydown: function (t) {
            var e, f, o, s, r;
            if (/(38|40|27)/.test(t.keyCode) && (e = n(this), t.preventDefault(), t.stopPropagation(), !e.is(".disabled, :disabled"))) {
                if (o = u(e), s = o.hasClass("open"), !s || s && t.keyCode == 27) return t.which == 27 && o.find(i)
                    .focus(), e.click();
                (f = n("[role=menu] li:not(.divider):visible a", o), f.length) && (r = f.index(f.filter(":focus")), t.keyCode == 38 && r > 0 && r--, t.keyCode == 40 && r < f.length - 1 && r++, ~r || (r = 0), f.eq(r)
                    .focus())
            }
        }
    };
    ...
    n(document)
        ...
        .on("keydown.dropdown.data-api", i + ", [role=menu]", t.prototype.keydown)
}(window.jQuery);
! function (n) {
    function t(t, i) {
        ...
        this.selector = (this.options.target || (r = n(t)
            .attr("href")) && r.replace(/.*(?=#[^\s]+$)/, "") || "") + " .nav li > a";
        this.$body = n("body");
        this.refresh();
        this.process()
    }
    t.prototype = {
        ...
        refresh: function () {
            ...
            this.offsets = n([]);
            this.targets = n([]);
            i = this.$body.find(this.selector)
                .map(function () {
                    var u = n(this),
                    ...
                    return r && r.length && [
                        [r.position()
                            .top + (!n.isWindow(t.$scrollElement.get(0)) && t.$scrollElement.scrollTop()), i
                        ]
                    ] || null
                })
                .sort(function (n, t) {
    ...
    t.prototype = {
        ...
        show: function () {
            var t = this.element,
                ...
                r, u, f;
            (i || (i = t.attr("href"), i = i && i.replace(/.*(?=#[^\s]*$)/, "")), t.parent("li")
                .hasClass("active")) || (r = e.find(".active:last a")[0], f = n.Event("show", {
                relatedTarget: r
        ...
        activate: function (t, i, r) {
            function f() {
                ...
                t.parent(".dropdown-menu") && t.closest("li.dropdown")
                    .addClass("active");
                r && r()
            }
            var u = i.find("> .active"),
    ...
    t.prototype = {
        ...
        enter: function (t) {
            ...
            if (this._options && n.each(this._options, function (n, t) {
                u[n] != t && (r[n] = t)
            }, this), i = n(t.currentTarget)[this.type](r)
                .data(this.type), !i.options.delay || !i.options.delay.show) return i.show();
        ...
        leave: function (t) {
            var i = n(t.currentTarget)[this.type](this._options)
                .data(this.type);
        ...
        hide: function () {
            function r() {
                var i = setTimeout(function () {
                    t.off(n.support.transition.end)
                        .detach()
                }, 500);
        ...
        fixTitle: function () {
            var n = this.$element;
            (n.attr("title") || typeof n.attr("data-original-title") != "string") && n.attr("data-original-title", n.attr("title") || "")
                .attr("title", "")
        },
        hasContent: function () {
        ...
        toggle: function (t) {
            var i = t ? n(t.currentTarget)[this.type](this._options)
                .data(this.type) : this;
            i.tip()
                .hasClass("in") ? i.hide() : i.show()
        },
        destroy: function () {
            this.hide()
...
! function (n) {
    var t = function (t, i) {
            ...
            this.$window = n(window)
                ...
                .on("click.affix.data-api", n.proxy(function () {
    ...
    t.prototype.checkPosition = function () {
        if (this.$element.is(":visible")) {
            var o = n(document)
                ...
                u = t.top,
                i;
            (typeof t != "object" && (r = u = t), typeof u == "function" && (u = t.top()), typeof r == "function" && (r = t.bottom()), i = this.unpin != null && f + this.unpin <= e.top ? !1 : r != null && e.top + this.$element.height() >= o - r ? "bottom" : u != null && f <= u ? "top" : !1, this.affixed !== i) && (this.affixed = i, this.unpin = i == "bottom" ? e.top - f : null, this.$element.removeClass("affix affix-top affix-bottom")
                .addClass("affix" + (i ? "-" + i : "")))
        }
    };
    i = n.fn.affix;
...
! function (n) {
    ...
    n(document)
        .on("click.alert.data-api", i, t.prototype.close)
}(window.jQuery);
! function (n) {
    var t = function (t, i) {
            this.$element = n(t);
    ...
    t.prototype.setState = function (n) {
        ...
        setTimeout(function () {
            n == "loadingText" ? t.addClass(i)
                .attr(i, i) : t.removeClass(i)
                .removeAttr(i)
        }, 0)
    };
...
! function (n) {
    var t = function (t, i) {
            ...
            this.options = i;
            this.options.pause == "hover" && this.$element.on("mouseenter", n.proxy(this.pause, this))
    ...
    t.prototype = {
        ...
        to: function (t) {
            ...
            if (!(t > this.$items.length - 1) && !(t < 0)) return this.sliding ? this.$element.one("slid", function () {
                ...
                .cycle() : this.slide(t > i ? "next" : "prev", n(this.$items[t]))
        },
        pause: function (t) {
            return t || (this.paused = !0), this.$element.find(".next, .prev")
                .length && n.support.transition.end && (this.$element.trigger(n.support.transition.end), this.cycle(!0)), clearInterval(this.interval), this.interval = null, this
        },
        next: function () {
    ...
    n.fn.carousel = function (i) {
        return this.each(function () {
            ...
            typeof i == "number" ? r.to(i) : e ? r[e]() : u.interval && r.pause()
                .cycle()
        })
    };
    ...
    n(document)
        .on("click.carousel.data-api", "[data-slide], [data-slide-to]", function (t) {
            var i = n(this),
                ...
                f;
            r.carousel(e);
            (f = i.attr("data-slide-to")) && r.data("carousel")
                .pause()
                .to(f)
                .cycle();
            t.preventDefault()
...
! function (n) {
    ...
    t.prototype = {
        ...
        select: function () {
            var n = this.$menu.find(".active")
                .attr("data-value");
            return this.$element.val(this.updater(n))
                .change(), this.hide()
        },
        updater: function (n) {
            return n
        ...
        sorter: function (n) {
            for (var i = [], r = [], u = [], t; t = n.shift();) t.toLowerCase()
                .indexOf(this.query.toLowerCase()) ? ~t.indexOf(this.query) ? r.push(t) : u.push(t) : i.push(t);
            return i.concat(r, u)
        },
        ...
        render: function (t) {
            ...
            return t = n(t)
                .map(function (t, r) {
                    return t = n(i.options.item)
                        .attr("data-value", r), t.find("a")
                        .html(i.highlighter(r)), t[0]
                }), t.first()
                .addClass("active"), this.$menu.html(t), this
        },
        next: function () {
            var i = this.$menu.find(".active")
                    .removeClass("active"),
                t = i.next();
        ...
        listen: function () {
            this.$element.on("focus", n.proxy(this.focus, this))
            ...
            this.$menu.on("click", n.proxy(this.click, this))
    ...
    n(document)
        .on("focus.typeahead.data-api", '[data-provide="typeahead"]', function () {
            var t = n(this);
...
! function (n, t) {
    ...
    function gt(t, i) {
        ...
        return t.unbind(e)
            ...
            .find(".actions a")
            .unbind(e), t.removeClass(i.clearFixCssClass + " vertical"), f = t.find(".content > *"), f.removeData("loaded")
            .removeData("mode")
            .removeData("url"), f.removeAttr("id")
            .removeAttr("role")
            .removeAttr("tabindex")
            .removeAttr("class")
            .removeAttr("style")
            ._removeAria("labelledby")
            ._removeAria("hidden"), t.find(".content > [data-mode='async'],.content > [data-mode='iframe']")
            .empty(), r = n('<{0} class="{1}"><\/{0}>'.format(t.get(0)
            .tagName, t.attr("class"))), u = t._id(), null != u && "" !== u && r._id(u), r.html(t.find(".content")
            .html()), t.after(r), t.remove(), r
    }

    function ft(n, t) {
        var i = n.find(".steps li")
            .eq(t.currentIndex);
        n.triggerHandler("finishing", [t.currentIndex]) ? (i.addClass("done")
            .removeClass("error"), n.triggerHandler("finished", [t.currentIndex])) : i.addClass("error")
    }
    ...
    function ti(n, t, i, u) {
        if ((0 > u || u >= i.stepCount) && r(rt), !(t.forceMoveForward && u < i.currentIndex)) {
            ...
            return n.triggerHandler("stepChanging", [i.currentIndex, u]) ? (i.currentIndex = u, nt(n, t, i), d(n, t, i, f), l(n, t, i), ot(n, t, i), ai(n, t, i, u, f), n.triggerHandler("stepChanged", [u, f])) : n.find(".steps li")
                .eq(f)
                .addClass("error"), !0
        }
    }
    ...
    function ri(t) {
        ...
        return this.each(function () {
            ...
            ci(t, i, r);
            oi(t, i);
            i.autoFocus && 0 === tt && s(t, i.startIndex)
                .focus()
        })
    }
    ...
    function et(t, i, f, e, o) {
        ...
        return (null == o.contentMode || o.contentMode === u.html) && s.html(o.content), 0 === e ? c.prepend(s)
            .prepend(h) : p(t, e - 1)
            .after(s)
            .after(h), ct(t, f, s, e), lt(t, i, f, h, e), ht(t, i, f, e), e === f.currentIndex && d(t, i, f), l(t, i, f), t
    }
    ...
    function fi(t) {
        var r = n(this),
            ...
            o = i(r),
            e;
        if (u.suppressPaginationOnFocus && r.find(":focus")
            .is(":input")) return t.preventDefault(), !1;
        e = {
            left: 37,
            right: 39
        };
    ...
    function ot(t, i, r) {
        var f, e;
        if (r.stepCount > 0 && (f = w(t, r.currentIndex), !i.enableContentCache || !f.contentLoaded)) switch (c(u, f.contentMode)) {
            case u.iframe:
                t.find(".content > .body")
                    .eq(r.currentIndex)
                    .empty()
                ...
                break;
            case u.async:
                e = p(t, r.currentIndex)
                    ._aria("busy", "true")
                    .empty()
                    .append(g(i.loadingTemplate, {
    ...
    function l(n, t, i) {
        var r, u, f;
        t.enablePagination && (r = n.find(".actions a[href$='#finish']")
            .parent(), u = n.find(".actions a[href$='#next']")
            .parent(), t.forceMoveForward || (f = n.find(".actions a[href$='#previous']")
            .parent(), f._enableAria(i.currentIndex > 0)), t.enableFinishButton && t.showFinishButtonAlways ? (r._enableAria(i.stepCount > 0), u._enableAria(i.stepCount > 1 && i.stepCount > i.currentIndex + 1)) : (r._showAria(t.enableFinishButton && i.stepCount === i.currentIndex + 1), u._showAria(0 === i.stepCount || i.stepCount > i.currentIndex + 1)
            ._enableAria(i.stepCount > i.currentIndex + 1 || !t.enableFinishButton)))
    }
    ...
    function d(t, i, r, u) {
        var e = s(t, r.currentIndex),
            ...
            f;
        null != u && (f = s(t, u), f.parent()
            .addClass("done")
            .removeClass("error")
            ._selectAria(!1), h.eq(u)
            .removeClass("current")
            .next(".body")
            .removeClass("current"), o = f.find(".current-info"), e.focus());
        e.prepend(o)
            .parent()
            ._selectAria()
            .removeClass("done")
    ...
    function si(n, t, i, r) {
        return 0 > r || r >= i.stepCount || i.currentIndex === r ? !1 : (hi(n, r), i.currentIndex > r && (i.currentIndex--, nt(n, t, i)), i.stepCount--, ni(n, r)
            .remove(), p(n, r)
            .remove(), s(n, r)
            .parent()
            .remove(), 0 === r && n.find(".steps li")
            .first()
            .addClass("first"), r === i.stepCount && n.find(".steps li")
            .eq(r)
            .addClass("last"), ht(n, t, i, r), l(n, t, i), !0)
    }
    ...
    function ci(t, i, r) {
        ...
        t.attr("role", "application")
            .empty()
            .append(s)
            .append(u)
            .addClass(i.cssClass + " " + i.clearFixCssClass + o);
        l.each(function (i) {
            ct(t, r, n(this), i)
        });
        h.each(function (u) {
    ...
    function ai(t, r, u, f, e) {
        var y = t.find(".content > .body"),
            a = c(o, r.transitionEffect),
        ...
        switch (a) {
            case o.fade:
            case o.slide:
                p = a === o.fade ? "fadeOut" : "slideUp";
                w = a === o.fade ? "fadeIn" : "slideDown";
                u.transitionElement = v;
                h[p](s, function () {
                    var r = n(this)
                            ._showAria(!1)
                            .parent()
                            .parent(),
                        t = i(r);
                    t.transitionElement && (t.transitionElement[w](s, function () {
                        n(this)
                            ._showAria()
    ...
    function vi(t) {
        ...
        var u = n(this),
            ...
            h = e.currentIndex;
        return u.parent()
            .is(":not(.disabled):not(.current)") && (o = u.attr("href"), c = parseInt(o.substring(o.lastIndexOf("-") + 1), 0), ti(r, l, e, c)), h === e.currentIndex ? (s(r, h)
            .focus(), !1) : void 0
    }
    ...
    n.fn.extend({
        ...
        _enableAria: function (n) {
            return null == n || n ? this.removeClass("disabled")
                ._aria("disabled", "false") : this.addClass("disabled")
                ._aria("disabled", "true")
        },
        _showAria: function (n) {
            return null == n || n ? this.show()
                ._aria("hidden", "false") : this.hide()
                ._aria("hidden", "true")
        },
        _selectAria: function (n) {
            return null == n || n ? this.addClass("current")
                ._aria("selected", "true") : this.removeClass("current")
                ._aria("selected", "false")
        },
        _id: function (n) {
    ...
    function (n) {
        n.extend(n.fn, {
            validate: function (t) {
                ...
                return i ? i : (this.attr("novalidate", "novalidate"), i = new n.validator(t, this[0]), n.data(this[0], "validator", i), i.settings.onsubmit && (this.validateDelegate(":submit", "click", function (t) {
                    ...
                    n(t.target)
                        .hasClass("cancel") && (i.cancelSubmit = !0);
                    void 0 !== n(t.target)
                        .attr("formnovalidate") && (i.cancelSubmit = !0)
                }), this.submit(function (t) {
                    function r() {
                        var r;
                        return i.settings.submitHandler ? (i.submitButton && (r = n("<input type='hidden'/>")
                            .attr("name", i.submitButton.name)
                            .val(n(i.submitButton)
                            .val())
                            .appendTo(i.currentForm)), i.settings.submitHandler.call(i, i.currentForm, t), i.submitButton && r.remove(), !1) : !0
                    }
        ...
        n.validator.format = function (t, i) {
            ...
            } : (arguments.length > 2 && i.constructor !== Array && (i = n.makeArray(arguments)
                .slice(1)), i.constructor !== Array && (i = [i]), n.each(i, function (n, i) {
        ...
        n.extend(n.validator, {
            defaults: {
                ...
                onfocusin: function (n) {
                    this.lastActive = n;
                    this.settings.focusCleanup && !this.blockFocusCleanup && (this.settings.unhighlight && this.settings.unhighlight.call(this, n, this.settings.errorClass, this.settings.validClass), this.addWrapper(this.errorsFor(n))
                        .hide())
                },
            ...
            prototype: {
                init: function () {
                    ...
                    this.containers = n(this.settings.errorContainer)
                    ...
                    n(this.currentForm)
                        .validateDelegate(":text, [type='password'], [type='file'], select, textarea, [type='number'], [type='search'] ,[type='tel'], [type='url'], [type='email'], [type='datetime'], [type='date'], [type='month'], [type='week'], [type='time'], [type='datetime-local'], [type='range'], [type='color'] ", "focusin focusout keyup", i)
                        .validateDelegate("[type='radio'], [type='checkbox'], select, option", "click", i);
                    this.settings.invalidHandler && n(this.currentForm)
                        .bind("invalid-form.validate", this.settings.invalidHandler)
                },
                form: function () {
                    return this.checkForm(), n.extend(this.submitted, this.errorMap), this.invalid = n.extend({}, this.errorMap), this.valid() || n(this.currentForm)
                ...
                resetForm: function () {
                    n.fn.resetForm && n(this.currentForm)
                        .resetForm();
                    this.submitted = {};
                ...
                elements: function () {
                    ...
                    return n(this.currentForm)
                        ...
                        .filter(function () {
                            return !this.name && t.settings.debug && window.console && console.error("%o has no name assigned", this), this.name in i || !t.objectLength(n(this)
                ...
                elementValue: function (t) {
                    var r = n(t)
                        ...
                        i = n(t)
                            .val();
                    return "radio" === r || "checkbox" === r ? n("input[name='" + n(t)
                        .attr("name") + "']:checked")
                        .val() : "string" == typeof i ? i.replace(/\r/g, "") : i
                },
                check: function (t) {
                    var r, u;
                    t = this.validationTargetFor(this.clean(t));
                ...
                customDataMessage: function (t, i) {
                    return n(t)
                        .data("msg-" + i.toLowerCase()) || t.attributes && n(t)
                        .attr("data-msg-" + i.toLowerCase())
                },
                ...
                showLabel: function (t, i) {
                    ...
                    r.length ? (r.removeClass(this.settings.validClass)
                        .addClass(this.settings.errorClass), r.html(i)) : (r = n("<" + this.settings.errorElement + ">")
                        .attr("for", this.idOrName(t))
                        .addClass(this.settings.errorClass)
                        .html(i || ""), this.settings.wrapper && (r = r.hide()
                        .show()
                        .wrap("<" + this.settings.wrapper + "/>")
                        .parent()), this.labelContainer.append(r)
                        .length || (this.settings.errorPlacement ? this.settings.errorPlacement(r, n(t)) : r.insertAfter(t)));
                ...
                validationTargetFor: function (n) {
                    return this.checkable(n) && (n = this.findByName(n.name)
                        .not(this.settings.ignore)[0]), n
                },
                ...
                stopRequest: function (t, i) {
                    ...
                    i && 0 === this.pendingRequest && this.formSubmitted && this.form() ? (n(this.currentForm)
                        .submit(), this.formSubmitted = !1) : !i && 0 === this.pendingRequest && this.formSubmitted && (n(this.currentForm)
            ...
            attributeRules: function (t) {
                var u = {},
                    ...
                    r, i;
                for (r in n.validator.methods) "required" === r ? (i = e.get(0)
                    .getAttribute(r), "" === i && (i = !0), i = !!i) : i = e.attr(r), /min|max/.test(r) && (null === f || /number|range|text/.test(f)) && (i = Number(i)), i ? u[r] = i : f === r && "range" !== f && (u[r] = !0);
            ...
            methods: {
                required: function (t, i, r) {
                    ...
                    return this.checkable(i) ? this.getLength(t, i) > 0 : n.trim(t)
                        .length > 0
                },
                email: function (n, t) {
                ...
                equalTo: function (t, i, r) {
                    var u = n(r);
                    return this.settings.onfocusout && u.unbind(".validate-equalTo")
    ...
    function (n) {
        ...
        n.ajaxPrefilter ? n.ajaxPrefilter(function (n, i, r) {
            ...
            var f = ("mode" in r ? r : n.ajaxSettings)
                    .mode,
                u = ("port" in r ? r : n.ajaxSettings)
                    .port;
    ...
    window.PR_SHOULD_USE_CONTINUATION = !0,
        function () {
            function d(n) {
                ...
                function h(n) {
                    var u = n.substring(1, n.length - 1)
                            ...
                            if (v = s.className, (rt !== b || w.test(v)) && !d.test(v)) {
                                ...
                                if (!r) {
                                    if (s.className += " prettyprinted", r = rt.lang, r || (r = v.match(p), !r && (ut = nt(s)) && tt.test(ut.tagName) && (r = ut.className.match(p)), r && (r = r[1])), g.test(s.tagName)) i = 1;
                                        ...
                                        o = k.defaultView,
                                        i = (i = i ? i.whiteSpace : o && o.getComputedStyle ? o.getComputedStyle(s, n)
                                            .getPropertyValue("white-space") : 0) && "pre" === i.substring(0, 3);
                                    o = rt.linenums;
...
$(function () {
    var t = /\.(zip|exe|pdf|doc*|xls*|ppt*|mp3|js|md)$/i,
        n = "";
    $("base")
        .attr("href") != undefined && (n = $("base")
        .attr("href"));
    $("a")
        .each(function () {
            var i = $(this)
                .attr("href");
            i && i.match(/^https?\:/i) && !i.match(document.domain) ? $(this)
                .click(function () {
                    return ga("send", "event", "External", "Click", i.replace(/^https?\:\/\//i, "")), $(this)
                        .attr("target") != null && $(this)
                        .attr("target")
                        .toLowerCase() !== "_blank" ? (setTimeout(function () {
                        location.href = i
                    }, 200), !1) : void 0
                }) : i && i.match(/^mailto\:/i) ? $(this)
                .click(function () {
                    ga("send", "event", "Email", "Click", i.replace(/^mailto\:/i, ""))
                }) : i && i.match(t) && $(this)
                .click(function () {
                    return ga("send", "event", "Download", "Click", i), $(this)
                        .attr("target") != null && $(this)
                        .attr("target")
                        .toLowerCase() !== "_blank" ? (setTimeout(function () {
                        location.href = n + i
